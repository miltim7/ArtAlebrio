          ...
          <div class="header-top__right">
            ...
            <div class="user">
              ...
              >
                ...
                <a class="user__exit" href="" @click="handleLogout">
                  <i>
                    <svg
                      width="15"
                      height="15"
        ...
        <div class="header-bottom__inner">
          <div class="header-bottom__wrap">
            ...
            <div class="header-bottom__right">
              ...
              <!-- User dropdown in header-bottom (duplicate) -->
              <div class="user">
                <div class="user__show" @click="toggleUserDropdown">
                  <div class="user__img">
                    <img src="/images/user-icon5.svg" alt="" />
                  ...
                  >
                    <div class="header__catalog-item2">
                      <div
                        ...
                        @click="toggleMobileCatalogItemAuth(index)"
                      >
                        <a href="catalog.html" @click.stop>
        ...
        <div class="header-top__inner">
          ...
          <div class="header-top__right">
            <div
              ...
              :class="{ active: languageSelectOpen }"
            >
              <select @focus="toggleLanguageSelect" @blur="closeLanguageSelect">
                <option value="ru">RU</option>
                <option value="en">ENG</option>
              </select>
            </div>
                ...
                <div class="header__catalog">
                  ...
                  >
                    <div class="header__catalog-wrap tabs-inner">
                      ...
                      <div class="header__catalog-head">
                        <a
                          v-for="(category, index) in catalogCategories"
                          :key="category.id"
                          href=""
                          :data-tab-path="category.id"
                          class="header__catalog-tab tab"
                          :class="{ 'tab--active': activeTab === category.id }"
                          @mouseenter="setActiveTab(category.id)"
                        >
                          <i>
          ...
          <div class="header-bottom__group">
            <div class="header__catalog">
              ...
              >
                ...
                <div class="header__catalog-items2">
                  <div
                    v-for="(category, index) in mobileCatalogCategories"
                    :key="index"
                    class="header__catalog-item2"
                  >
                    <div class="header__catalog-item2">
                      <div
                        class="item-show"
                        :class="{ 'item-show--active': category.isOpen }"
...
export default {
  ...
  data() {
    return {
      ...
      catalogTabs: [
        { id: 1, title: "Картины", icon: "/images/catalog-icon11.svg" },
        { id: 2, title: "Дом и стиль жизни", icon: "/images/catalog-icon12.svg" },
        { id: 3, title: "Рисунок, графика", icon: "/images/catalog-icon13.svg" },
        { id: 4, title: "Аксессуары", icon: "/images/catalog-icon14.svg" },
        { id: 5, title: "Сумки и кошельки", icon: "/images/catalog-icon15.svg" },
        { id: 6, title: "Украшения", icon: "/images/catalog-icon16.svg" },
        { id: 7, title: "Игрушки и игры", icon: "/images/catalog-icon17.svg" },
        { id: 8, title: "Материалы для творчества", icon: "/images/catalog-icon18.svg" },
        { id: 9, title: "Коллекционирование", icon: "/images/catalog-icon19.svg" },
      ],

      // Mobile catalog data
      mobileCatalogCategories: [
        {
          title: "Картины",
          icon: "/images/catalog-icon11.svg",
          isOpen: false,
  ...
  methods: {
    ...
    // Catalog item expansion toggle
    toggleCatalogItem(itemKey) {
      if (this.catalogItemsExpanded[itemKey]) {
        this.catalogItemsExpanded[itemKey] = false;
      } else {
        this.catalogItemsExpanded[itemKey] = true;
      }
    },
    ...
    // More/Less toggle for catalog items
    toggleMore(event) {
    ...
    // Demo methods
    toggleAuthDemo() {
      this.demoAuthMode = !this.demoAuthMode;
    },
  },
};
</script>
